...
const EventGenerator2 = require('./EventGenerator2');
...
class Scene extends tripcore.Scene {
  ...
  constructor(container, options) {
    ...
    this.viewEventGenerator = new EventGenerator2(this);
    this.views = [];
    ...
    this.perspectiveCamera.position.set(100, 50, 0);
    this.perspectiveCamera.up.set(
      options.cameraUp.x,
      options.cameraUp.y,
      options.cameraUp.z);
    ...
    this.orthoCamera = new THREE.OrthographicCamera(-10000, 10000, 5000, -5000, 1, 250000);
    ...
    const trackball = new Trackball(this, this.eventGenerator);
    ...
    this.switchToPerspective = () => {
      trackball.switchToPerspective();
    };

    this.switchToTopBottom = () => {
      trackball.switchToTopBottom();
    };
