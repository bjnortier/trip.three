...
class AxesView extends View {
  ...
  render() {
    ...
    axes[0].vertices.push(new V3(0, 0, 0));
    axes[0].vertices.push(new V3(length, 0, 0));
    axes[1].vertices.push(new V3(0, 0, 0));
    axes[1].vertices.push(new V3(0, length, 0));
    axes[2].vertices.push(new V3(0, 0, 0));
    axes[2].vertices.push(new V3(0, 0, length));
    axes[3].vertices.push(new V3(0, 0, 0));
    axes[3].vertices.push(new V3(-length, 0, 0));
    axes[4].vertices.push(new V3(0, 0, 0));
    axes[4].vertices.push(new V3(0, -length, 0));
    axes[5].vertices.push(new V3(0, 0, 0));
    axes[5].vertices.push(new V3(0, 0, -length));
